...
3.  [cite_start]**Data Dictionary:** Từ điển dữ liệu chi tiết các thuộc tính. [cite: 152]
   
5.  [cite_start]**Use Case Diagram:** Sơ đồ chức năng hệ thống. [cite: 153]
   
7.  [cite_start]**Java Source Code:** Bao gồm JPA Entities và giao diện Swing. [cite: 2, 131]
   
9.  **Lambda Queries:** Mỗi thành viên triển khai từ 5-7 câu truy vấn Java Streams/Lambda.
